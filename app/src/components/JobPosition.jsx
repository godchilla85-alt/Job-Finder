...
export function JobPosition({ value, onChange }) {
  ...
  return (
    ...
    >
      <Label className="text-sm font-bold uppercase text-stone-500">Job Position</Label>
      
      <div className="flex flex-col gap-2 mt-2">
        <CustomCheckbox value="Remote">Remote</CustomCheckbox>
        <CustomCheckbox value="Office">Office</CustomCheckbox>
